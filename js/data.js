...
(function () {
  ...
  const NAT_SQUADS = {
    ...
    AR: sq("GOL:Emiliano Martínez, GOL:Gerónimo Rulli, GOL:Juan Musso, ZAG:Cristian Romero, ZAG:Nicolás Otamendi, ZAG:Lisandro Martínez, ZAG:Facundo Medina, LAT:Nahuel Molina, LAT:Gonzalo Montiel, LAT:Nicolás Tagliafico, VOL:Rodrigo De Paul, VOL:Enzo Fernández, VOL:Leandro Paredes, MEI:Alexis Mac Allister, MEI:Giovani Lo Celso, MEI:Thiago Almada, PON:Valentín Barco, PON:Nicolás González, ATA:Lionel Messi, ATA:Julián Álvarez, ATA:Lautaro Martínez"),
    FR: sq("GOL:Mike Maignan, GOL:Brice Samba, GOL:Robin Risser, ZAG:William Saliba, ZAG:Ibrahima Konaté, ZAG:Jules Koundé, ZAG:Dayot Upamecano, LAT:Lucas Digne, LAT:Malo Gusto, LAT:Lucas Hernández, VOL:Aurélien Tchouaméni, VOL:Adrien Rabiot, VOL:Warren Zaïre-Emery, MEI:Désiré Doué, MEI:Rayan Cherki, PON:Ousmane Dembélé, PON:Michael Olise, PON:Bradley Barcola, ATA:Kylian Mbappé, ATA:Marcus Thuram, ATA:Randal Kolo Muani"),
    ES: sq("GOL:Unai Simón, GOL:David Raya, GOL:Joan García, ZAG:Pau Cubarsí, ZAG:Robin Le Normand, ZAG:Dani Vivian, ZAG:Aymeric Laporte, LAT:Marc Cucurella, LAT:Alejandro Grimaldo, LAT:Jesús Areso, VOL:Rodri, VOL:Martín Zubimendi, VOL:Fabián Ruiz, MEI:Pedri, MEI:Mikel Merino, PON:Nico Williams, PON:Lamine Yamal, PON:Ferran Torres, ATA:Mikel Oyarzabal, ATA:Álvaro Morata"),
    EN: sq("GOL:Jordan Pickford, GOL:Dean Henderson, GOL:Aaron Ramsdale, ZAG:John Stones, ZAG:Marc Guéhi, ZAG:Jarell Quansah, ZAG:Trevoh Chalobah, LAT:Kyle Walker, LAT:Levi Colwill, LAT:Ezri Konsa, VOL:Declan Rice, VOL:Kobbie Mainoo, MEI:Jude Bellingham, MEI:Conor Gallagher, PON:Bukayo Saka, PON:Anthony Gordon, PON:Morgan Rogers, ATA:Harry Kane, ATA:Ollie Watkins, ATA:Marcus Rashford"),
    PT: sq("GOL:Diogo Costa, GOL:Rui Silva, GOL:José Sá, ZAG:Rúben Dias, ZAG:Gonçalo Inácio, ZAG:Tomás Araújo, ZAG:Renato Veiga, LAT:João Cancelo, LAT:Nuno Mendes, LAT:Diogo Dalot, LAT:Nélson Semedo, VOL:Vitinha, VOL:João Neves, VOL:Rúben Neves, MEI:Bruno Fernandes, MEI:Matheus Nunes, MEI:Bernardo Silva, PON:João Félix, PON:Francisco Trincão, PON:Francisco Conceição, PON:Pedro Neto, PON:Rafael Leão, ATA:Cristiano Ronaldo, ATA:Gonçalo Ramos"),
    DE: sq("GOL:Manuel Neuer, GOL:Oliver Baumann, GOL:Alexander Nübel, ZAG:Antonio Rüdiger, ZAG:Jonathan Tah, ZAG:Nico Schlotterbeck, LAT:Joshua Kimmich, LAT:David Raum, LAT:Benjamin Henrichs, VOL:Robert Andrich, VOL:İlkay Gündoğan, MEI:Jamal Musiala, MEI:Florian Wirtz, MEI:Aleksandar Pavlović, PON:Leroy Sané, PON:Karim Adeyemi, ATA:Niclas Füllkrug, ATA:Kai Havertz, ATA:Deniz Undav"),
    NL: sq("GOL:Bart Verbruggen, GOL:Mark Flekken, GOL:Robin Roefs, ZAG:Virgil van Dijk, ZAG:Nathan Aké, ZAG:Jan Paul van Hecke, ZAG:Micky van de Ven, LAT:Denzel Dumfries, LAT:Lutsharel Geertruida, LAT:Jorrel Hato, VOL:Mats Wieffer, VOL:Marten de Roon, MEI:Ryan Gravenberch, MEI:Justin Kluivert, PON:Cody Gakpo, PON:Donyell Malen, ATA:Memphis Depay, ATA:Wout Weghorst"),
    IT: sq("GOL:Gianluigi Donnarumma, GOL:Marco Carnesecchi, GOL:Elia Caprile, ZAG:Riccardo Calafiori, ZAG:Giorgio Scalvini, ZAG:Alessandro Bastoni, LAT:Federico Dimarco, LAT:Destiny Udogie, LAT:Marco Palestra, VOL:Sandro Tonali, VOL:Nicolò Barella, MEI:Niccolò Pisilli, MEI:Davide Frattesi, PON:Federico Chiesa, PON:Nicolò Zaniolo, ATA:Moise Kean, ATA:Mateo Retegui"),
    UY: sq("GOL:Fernando Muslera, GOL:Sergio Rochet, GOL:Franco Israel, ZAG:José María Giménez, ZAG:Ronald Araújo, ZAG:Sebastián Cáceres, LAT:Guillermo Varela, LAT:Mathías Olivera, VOL:Federico Valverde, VOL:Manuel Ugarte, MEI:Giorgian de Arrascaeta, MEI:Nicolás de la Cruz, PON:Facundo Pellistri, PON:Cristian Olivera, ATA:Darwin Núñez, ATA:Maximiliano Araújo"),
    CO: sq("GOL:Camilo Vargas, GOL:David Ospina, ZAG:Davinson Sánchez, ZAG:Yerry Mina, LAT:Daniel Muñoz, LAT:Johan Mojica, VOL:Kevin Castaño, VOL:Jefferson Lerma, MEI:James Rodríguez, MEI:Jhon Arias, PON:Luis Díaz, PON:Jorge Carrascal, ATA:Rafael Santos Borré, ATA:Jhon Córdoba"),
    MX: sq("GOL:Guillermo Ochoa, GOL:Luis Malagón, ZAG:César Montes, ZAG:Johan Vásquez, ZAG:Israel Reyes, LAT:Jorge Sánchez, LAT:Jesús Gallardo, VOL:Edson Álvarez, VOL:Luis Romo, MEI:Luis Chávez, MEI:Álvaro Fidalgo, MEI:Gilberto Mora, PON:Roberto Alvarado, PON:César Huerta, PON:Julián Quiñones, ATA:Santiago Giménez, ATA:Raúl Jiménez"),
    US: sq("GOL:Matt Turner, GOL:Ethan Horvath, ZAG:Chris Richards, ZAG:Miles Robinson, LAT:Sergiño Dest, LAT:Antonee Robinson, VOL:Tyler Adams, VOL:Weston McKennie, MEI:Gio Reyna, MEI:Malik Tillman, PON:Christian Pulisic, PON:Timothy Weah, ATA:Folarin Balogun, ATA:Ricardo Pepi"),
    JP: sq("GOL:Zion Suzuki, GOL:Keisuke Osako, ZAG:Ko Itakura, ZAG:Shogo Taniguchi, LAT:Yukinari Sugawara, LAT:Yuto Nagatomo, VOL:Wataru Endo, VOL:Hidemasa Morita, MEI:Takefusa Kubo, MEI:Ao Tanaka, PON:Kaoru Mitoma, PON:Ritsu Doan, ATA:Ayase Ueda, ATA:Takumi Minamino")
  };

...
(function () {
  ...
  // ---------- eventos de vida ----------
  // `social` (opcional, por opção): reação de verdade no feed pra decisão tomada — não só
  // pros 2-3 eventos que já tinham isso hard-coded antes. `k` é o perfil (mesmo dicionário
  ...
  const LIFE_EVENTS = [
    {
      ...
      opts: [
        { label: "Ir e passar a tarde com as crianças", fx: { rep: +6, fame: +2, cond: -4 }, note: "As fotos correram as redes. O gesto tocou a cidade.", social: { k: "torcida", text: "Fotos do {name} no hospital infantil hoje. Ídolo dentro e fora de campo. 👏" } },
        { label: "Ir rapidinho, tirar fotos e sair", fx: { rep: +1, fame: +1 }, note: "Cumpriu tabela. Passou despercebido." },
        { label: "Recusar para focar no treino", fx: { rep: -4, cond: +5 }, note: "O corpo agradece, mas a imprensa registrou a ausência.", social: { k: "zoeira", text: "{name} recusou visita ao hospital pra treinar. Prioridades, né?" } }
      ]
    },
    {
      ...
      opts: [
        { label: "Assinar o contrato", fx: { money: 350000, fame: +3, rep: -2 }, note: "Outdoor na avenida principal. O bolso agradece.", social: { k: "imprensa", text: "{name} fecha contrato milionário com marca de energético — outdoor já estampa a avenida principal." } },
        { label: "Pedir mais tempo para pensar", fx: {}, note: "O empresário torceu o nariz, mas aceitou." },
        { label: "Recusar: imagem vem antes de dinheiro", fx: { rep: +4 }, note: "A decisão virou pauta positiva nos jornais.", social: { k: "mesa", text: "{name} recusa proposta publicitária por questão de imagem. Postura elogiada pela crítica." } }
      ]
    },
    {
      ...
      opts: [
        { label: "Responder tudo com diplomacia", fx: { rep: +3 }, note: "Saiu ileso e elogiado pela postura.", social: { k: "mesa", text: "Postura serena de {name} na coletiva de hoje — nenhuma pergunta armadilha pegou." } },
        { label: "Alfinetar o próximo adversário", fx: { fame: +4, rep: -3, morale: +2 }, note: "Manchete no dia seguinte. O clima do jogo esquentou.", social: { k: "mesa", text: "{name} provoca o próximo adversário em coletiva: \"que venham\". O jogo esquentou.", hot: true } },
        { label: "Dar respostas curtas e ir embora", fx: { rep: -2, cond: +3 }, note: "A imprensa achou arrogante, mas você descansou.", social: { k: "zoeira", text: "Entrevista-relâmpago do {name} hoje. Simpatia não é bem o forte da vez." } }
      ]
    },
    {
      ...
      opts: [
        { label: "Festa completa até tarde", fx: { morale: +8, cond: -10, rep: -2 }, note: "A festa foi linda. O treino do dia seguinte, nem tanto.", social: { k: "zoeira", text: "Fotos da festa badalada da véspera rodando as redes. Treino de hoje promete." } },
        { label: "Jantar íntimo e voltar cedo", fx: { morale: +4, cond: -2 }, note: "Equilíbrio de atleta profissional." },
        { label: "Adiar a comemoração", fx: { morale: -5, cond: +4, rep: +1 }, note: "Foco total no jogo... e um gelo em casa.", social: { k: "torcida", text: "{name} abriu mão da festa da namorada pra focar 100% no jogo. Isso é profissional." } }
      ]
    },
    {
      ...
      opts: [
        { label: "Defendê-lo publicamente", fx: { rep: +5, morale: +3 }, note: "O elenco fechou com você. Liderança reconhecida.", social: { k: "mesa", text: "{name} saiu em defesa pública do companheiro criticado. Elenco fechado." } },
        { label: "Apoiar só no privado", fx: { morale: +2 }, note: "Ele agradeceu. Ninguém ficou sabendo." },
        { label: "Ficar de fora da polêmica", fx: { rep: -2 }, note: "Neutralidade também é escolha — e o grupo percebeu.", social: { k: "zoeira", text: "Colega sendo detonado pela torcida e nem um post de apoio do {name}. Reparado." } }
      ]
    },
    {
      ...
      opts: [
        { label: "Gravar o vídeo", fx: { fame: +6, cond: -5 }, note: "Milhões de views. Seu nome explodiu nas redes.", social: { k: "imprensa", text: "{name} quebra a internet em vídeo com influencer: milhões de views em 24h." } },
        { label: "Só se for depois da temporada", fx: { fame: +1 }, note: "Ficou a promessa. O influencer entendeu." },
        { label: "Recusar: folga é folga", fx: { cond: +6, fame: -1 }, note: "Descanso completo. As redes que esperem.", social: { k: "zoeira", text: "Convite de influencer gigante recusado pelo {name}. Exigente, hein." } }
      ]
    },
    {
    ...
    },
    {
      ...
      opts: [
        { label: "Ir e conversar sobre o futuro", fx: { rep: +3, morale: +3 }, note: "Saiu do jantar com moral e promessas.", social: { k: "clube", text: "Jantar produtivo entre {name} e a diretoria. Clima de confiança pro resto da temporada." } },
        { label: "Ir, mas só ouvir", fx: { rep: +1 }, note: "Educado e discreto. Anotaram." },
        { label: "Inventar compromisso", fx: { rep: -4, cond: +3 }, note: "A cadeira vazia foi notada na mesa do presidente.", social: { k: "mesa", text: "{name} não apareceu no jantar com a diretoria do {club}. Cadeira vazia rendeu assunto." } }
      ]
    },
    {
      ...
      opts: [
        { label: "Passar a tarde e dar uma palestra", fx: { rep: +5, morale: +4, cond: -3 }, note: "Os meninos não esqueceram. Você também não.", social: { k: "torcida", text: "{name} passou a tarde com a base do {club}. Os moleques não vão esquecer isso." } },
    ...
    },
    {
      ...
      opts: [
        { label: "Topar e abrir a intimidade", fx: { fame: +8, rep: -1, money: 400000 }, note: "Câmeras te seguem por meses. O público amou.", social: { k: "imprensa", text: "Documentário sobre a vida de {name} é anunciado por streaming. Câmeras vão acompanhar tudo." } },
        { label: "Só se focar no futebol", fx: { fame: +3 }, note: "Um recorte respeitoso — e bem recebido." },
        { label: "Recusar: prefiro privacidade", fx: { rep: +3 }, note: "Sua vida continua sua. A imprensa respeitou.", social: { k: "mesa", text: "{name} recusa documentário e preserva a privacidade. Decisão respeitada pela imprensa." } }
      ]
    },
    {
      ...
      opts: [
        { label: "Assinar contrato milionário", fx: { money: 700000, fame: +5 }, note: "Sua chuteira esgota nas lojas em uma semana.", social: { k: "imprensa", text: "Chuteira assinada por {name} esgota nas lojas em uma semana. Contrato milionário rendendo." } },
    ...
    },
    {
      ...
      opts: [
        { label: "Ir pessoalmente ao hospital", fx: { rep: +8, morale: +3, cond: -2 }, note: "Um momento que nenhum troféu paga. Ele foi pra cirurgia sorrindo.", social: { k: "torcida", text: "{name} visitou torcedor internado antes de uma cirurgia importante. A torcida do {club} inteira se emocionou." } },
    ...
    },
    {
      ...
      opts: [
        { label: "Detonar a arbitragem publicamente", fx: { fame: +4, rep: -4, morale: +2 }, note: "Manchete garantida — e possível multa da federação.", social: { k: "imprensa", text: "{name} detona a arbitragem em entrevista após pênalti não marcado. Bomba pra semana.", hot: true } },
        { label: "Reclamar com diplomacia", fx: { rep: +1 }, note: "Firme, mas sem passar do ponto." },
        { label: "Dizer que erros fazem parte", fx: { rep: +4, morale: -1 }, note: "Maturidade elogiada nos estúdios.", social: { k: "mesa", text: "Maturidade de {name} ao comentar o erro da arbitragem sem drama. Elogiado nos estúdios." } }
      ]
    },
    {
      ...
      opts: [
        { label: "Bancar a reforma inteira", fx: { money: -500000, rep: +10, morale: +4 }, note: "O campo agora leva o seu nome. Gerações vão jogar ali.", social: { k: "torcida", text: "{name} banca sozinho a reforma completa do campinho onde começou a jogar. Comunidade em festa.", hot: true } },
        { label: "Doar uma parte e mobilizar", fx: { money: -150000, rep: +5 }, note: "Você deu o pontapé; a comunidade completou.", social: { k: "torcida", text: "{name} doa parte da reforma do campinho da comunidade e ainda mobiliza o resto. Gesto reconhecido." } },
        { label: "Prometer ajudar mais pra frente", fx: { rep: -2 }, note: "A promessa ficou no ar.", social: { k: "zoeira", text: "{name} prometeu ajudar a reforma do campinho da comunidade... segue só na promessa." } }
      ]
    },
    {
    ...
    },
    {
      ...
      opts: [
        { label: "Assinar o contrato milionário", fx: { money: 900000, fame: +5, rep: -6 }, note: "Cachê gordo, mas parte da torcida não gostou de ver o ídolo estampando aposta.", social: { k: "zoeira", text: "{name} fecha contrato milionário com casa de apostas. Parte da torcida não curtiu ver o ídolo estampando aposta." } },
        { label: "Negociar uma campanha de jogo responsável", fx: { money: 400000, rep: +3, fame: +2 }, note: "Meio-termo bem recebido: dinheiro no bolso sem abrir mão da imagem.", social: { k: "mesa", text: "{name} negocia campanha de jogo responsável com casa de apostas. Meio-termo bem recebido pela crítica." } },
        { label: "Recusar o convite", fx: { rep: +4 }, note: "Ficou de fora da polêmica — e de uma bolada.", social: { k: "mesa", text: "{name} recusa contrato milionário com casa de apostas por questão de imagem." } }
      ]
    },
    {
      ...
      opts: [
        { label: "Comparecer e discursar", fx: { rep: +5, morale: +3, cond: -3 }, note: "Discurso emocionado, aplausos de pé. O presidente saiu satisfeito.", social: { k: "clube", text: "Discurso emocionado de {name} no evento institucional do {club}. Aplausos de pé, presidente satisfeito." } },
  ...
  CQ.nar = {
    PROFILES: PROFILES, LIFE_EVENTS: LIFE_EVENTS,

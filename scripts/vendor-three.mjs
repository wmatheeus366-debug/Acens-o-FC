/* CRAQUE — baixa/atualiza js/vendor/three.min.js e js/vendor/OrbitControls.js.
   three.js r140 é a última versão que ainda publica um build UMD clássico
   (build/three.min.js) e um OrbitControls não-módulo (examples/js/controls/
   OrbitControls.js) — versões mais novas migraram pra ES modules, incompatível com o
   jeito que scripts/build.mjs concatena os arquivos do jogo (script comum, sem
   import/export). Rodar de novo é seguro — sobrescreve os 2 arquivos.
